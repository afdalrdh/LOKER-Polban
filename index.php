...
<body>
    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="single-slider section-overly slider-height2 d-flex align-items-center" data-background="assets/img/wallpaper.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap text-center">
                                <h2>Dapatkan Pekerjaanmu Sekarang!</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="container">
                                ...
                                <div class="single-job-items mb-30">
                                    ...
                                    <div class="items-link items-link2 f-right">
                                        <a href="detail_loker.php">Full Time</a>
