...
$jmlhAkun = $user->find();
$akunVerified = $user->count(array('status' => true));
$akunUnVerify = $user->count(array('status' => false));

$jmlhLoker = $loker->find();
$lokerVerified = $loker->count(array('status' => true));
$lokerUnVerify = $loker->count(array('status' => false));
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php
                                        echo "<td class='huge'>$akunUnVerify</td>"
                                        ?>
                                    </div>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php
                                        echo "<td class='huge'>$akunVerified</td>"
                                        ?>
                                    </div>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php
                                        echo "<td class='huge'>$lokerUnVerify</td>"
                                        ?>
                                    </div>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php
                                        echo "<td class='huge'>$lokerVerified</td>"
                                        ?>
                                    </div>
